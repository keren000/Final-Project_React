...
class BookSearch extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={className} style={bookSearchStyle}>
        <input
          className="react-search-field-input"
          style={bookSearchInputStyle}
